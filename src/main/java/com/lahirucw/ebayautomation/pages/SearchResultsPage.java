...
public class SearchResultsPage {
    ...
    public SearchResultsPage() {
        ...
        WaitUtil.waitForAllVisible(By.cssSelector(".x-card a"));
        LoggerUtil.info("SearchResultsPage initialized");
    }
    
    // This screen size selection is removed from the Ebay Now.
...
//    }
    ...
    public ProductDetailsPage selectFirstProduct() {
        List<WebElement> products = DriverManager.getDriver().findElements(By.cssSelector(".x-card a"));
